 ...
 * client application used to talk with the authentication server.
 */
public interface AuthenticationClientInterface
{
    /**
     * Connect to the specified authentication server.  No other methods should
     * work until the client is connected to a authentication server.
     *
     * @param server The IP address or hostname of the authentication server
     * @param port The port that the authentication server is listening on
     *
    ...
    /**
     * Close down the connection to the authentication server.
     *
     */
    ...
    /**
     * Method used to get a token from the authentication server.  Right now,
     ...
     * a user should also remove the user from all existing groups.
     *
